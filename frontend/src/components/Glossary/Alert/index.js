    ...
    return (
        ...
        >
            <div className={styles.firstPara}>
                ...
                <div>
                    This term is no longer actively used on this website, as the method it was
                    once used for is obsolete and has been replaced. This entry is maintained for historical reasons.
                </div>
            </div>
        </Alert>
    )
