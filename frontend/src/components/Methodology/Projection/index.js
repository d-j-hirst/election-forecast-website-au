    ...
    return (
        <>
            ...
            <p>
                ...
                state election, the poll average can sometimes differ significantly from the polling average.
                Of course, any time before an election further reduces the predictiveness
            ...
            <ul>
                ...
                <li>LNP first preference vote (including combination of both parties' vote in WA)</li>
            ...
            <p>
                ...
                The fundamentals projection instead relies on known facts of the electoral situation:
            </p>
            <ul>
                <li>
                ...
                <li>
                    ...
                    election, this is taken into account using the forecast for said federal election.
                </li>
            </ul>
            <p>
            ...
            <p>
                ...
                "out-of-sample" data than the data that the model is trained on.)
                The predictive accuracy was compared to simple baselines: using the
            ...
            <p>
                ...
                these vote shares, and the federal results are excluded from the regression calculation for them 
                (which in turn results in a slightly improved fit for the state results).
            </p>
            <p>
            ...
            <p>
                ...
                The parameters for this process will depend on the vote type (the party and whether 2PP or FP)
                and the time until the election.
            ...
            <p>
                First, the <i>biases</i> of both the poll trend and the fundamentals are calculated - that is,
                ...
                from the election. (The bias for fundamentals is usually quite small). These biases are then subtracted
            ...
            <p>
                ...
                if (after correction for bias) the fundamentals have the ALP's TPP vote share at 54 but the poll trend is at 48,
                ...
                the error is minimized across all elections (technically a combination of absolute mean and absolute median errors
                is used for this purpose). ** Then for each election this mixed estimate is calculated, and a further correction
                is made to calculate the bias of this mixed estimate. This is then subtracted to create the final estimate
                for the election. For two-party-preferred votes, the mix 
            </p>
            <p>
                ...
                so that any asymmetry may be measured.
            </p>
            <p>
                ...
                just one or two elections), and indeed are likely to mislead if they were actually used for modelling,
                ...
                election to avoid "polluting" that time point with the considerably more uncertain earlier estimates.
            </p>
            <p>
