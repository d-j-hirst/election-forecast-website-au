...
const GuideTcpScenarios = props => {
  return (
    <>
      <h4 id="tcp-scenarios">
        Two-candidate preferred (TCP) scenarios and tactical voting
      </h4>
      <p>
        ...
        <strong>two-candidate-preferred vote (TCP)</strong>. The party with the
        higher two-candidate-preferred vote then goes on to win the seat.
      </p>
      <p>
        You might also see the term{' '}
        <strong>two-party-preferred vote (TPP)</strong> (in the vote-trend
      ...
      <p>
        One important thing to note for the TCP scenarios is that this site only
        reports TCP results for simulated results where, in those simulations,
        ...
        both major parties in the TCP, but this only applies to the very unusual
      ...
      <p>
        ...
        candidate to the final two and winning the TCP against the Coalition
      ...
      <p>
        ...
        site <strong>does not recommend</strong> using the printed TCP scenarios
        for deciding how to vote tactically. This is because, as explained
        above, the TCP scenarios come from different kinds of elections. For
        ...
        the TCP projection on this site would show Labor with a higher TCP
        ...
        better in the one election that actually takes place, and the TCP
